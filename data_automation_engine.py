...
data = {
    "ticket_text": [
        ...
        "Can I get a refund for my last inovoice?",
...
'''vectorizing the strings into numerical featurew matrices '''
print("[System] Training the classification model...")

#converting text tokens into frequency scores based on how unique a word is using Tfvectorizer
...
new_email = "Hey, I need a refunf on my credit card bill please"
